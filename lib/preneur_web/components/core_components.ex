defmodule PreneurWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PreneurWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PreneurWeb.Gettext, "errors", msg, opts)
    end
  end
